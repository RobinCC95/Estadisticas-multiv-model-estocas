...
Para este ejercicio se pide un hacer una regresion logistica de una tabla que realciona las estado nutricional
...
el coeficiente de regresión para la variable predictora, desemp_esc, es positivo, lo que sugiere que a medida que aumenta
el nivel de desempeño escolar, la probabilidad de estar en el estado de nutrición deseado (estado_nutric = bueno) aumenta. 
Además, el valor p asociado con la variable predictora es menor que 0,05, lo que indica que la relación entre la variable 
