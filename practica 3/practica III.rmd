...
$R^2$ mayor al 90%. Solo se hizo modelos lm() hasta la variable 2 los modelos. 
...
dist_euclidianas <- dist(datos, method="euclidean")
summary(dist_euclidianas)

# Calcular las distancias mahalanobis
dist_mahalanobis <- mahalanobis(datos,colMeans(datos),cov(datos))
