...
```{r}
library(readxl)
datos = data.frame(read_excel("practica 3/dataset_ejer1.xlsx"))
dim(datos)
```
...
```{r}
library(readxl)
datos <- data.frame(read_excel("practica 3/dataset_ejer_2.xlsx"))
dim(datos)
```
...
```{r}
library(readxl)
datos <- data.frame(read_excel("practica 3/dataset_ejer_3.xlsx"))
dim(datos)
```
